...
<div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="test">
            <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/api/car/carList.html">车辆管理</a></li>
            ...
            <c:if test="${sessionScope.user.userRole==2}">
                <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/api/user/userList.html">学员管理</a></li>
            </c:if>
        </ul>
    </div>
</div>
